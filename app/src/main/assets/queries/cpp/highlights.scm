...
; Anotaciones para system_lib_string
(system_lib_string) @string.system
(system_lib_string) @string.library
(system_lib_string) @string.include

; Anotaciones para function_definition
...
; Anotaciones para preproc_include
(preproc_include) @preprocessor.include
(preproc_include
  path: (system_lib_string) @string.system
)
