...
data class Token(
    ...
    val positions: IntArray  // Array con las posiciones [startByte, endByte, startRow, startCol, endRow, endCol]
) {
    ...
    val startCol: Int get() = positions[3]
    val endRow: Int get() = positions[4]
    val endCol: Int get() = positions[5]
